                        ...
                        <form action="{{ route('grandchild.store') }}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="name" value="{{ $grandchild->name ?? old('name') }}" id="name"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="gender" id="gender" class="form-control custom-select">
                                        <option value="0" @if($grandchild->gender == 0) selected @endif>Pria</option>
                                        <option value="1" @if($grandchild->gender == 1) selected @endif>Perempuan</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select name="child_id" id="child_id" class="form-control custom-select">
                                        @foreach ($parents as $parent)
                                            <option {{ $grandchild->child()->find($parent->id) ? 'selected' : '' }}
                                                value="{{ $parent->id }}">
                                                {{ $parent->name }}</option>
                                        @endforeach
                                    </select>
